...
;(function($, window, document, undefined) {
        ...
        init: function() {
            ...
            $.each(this.settings.buttons, function(index, value) {
                $.each(networks, function(k, v) {
                    if (value === k) {
                        var $icon = $("<i>", { class: "margin-top-5 fa fa-" + value.replace("linkedin","fire") }), //TODO: fix this urgly hack 
    ...
    var places = ["top-left", "top-right"],
        networks = {
            ...
            "linkedin": {
                className: "linkedin",
                url: "http://localhost:3000/api/new_kandle?text={url}&comment={title}",//"https://www.linkedin.com/shareArticle?mini=true&url={url}&title={title}&summary={description}&source="
            },
            "odnoklassniki": {
